...
tools:
  ...
  - "Resend"
gallery:
  - src: "/images/projects/ipn-member-portal/01.png"
    caption: "IPN’s Global Member Directory - Allowing members to find and connect with each based on similar interest, background, and location."
  - src: "/images/projects/ipn-member-portal/02.png"
    caption: "Using the IPN member directory, you can connect with them directly after selecting their profile."
  - src: "/images/projects/ipn-member-portal/03.png"
    caption: "When they accept your friend request, you can see their personal contact information and seamlessly connect with them on WhatsApp by selecting Message on WhatsApp."
  - src: "/images/projects/ipn-member-portal/04.png"
    caption: "A member profile section for members to adjust settings and details about themselves."
  ...
  - src: "/images/projects/ipn-member-portal/07.png"
    caption: "Feedback modals located on each page for members to submit any bugs, feedback, and suggestions. Submissions sent to IPN leadership automatically in Slack via a webhook."
---
...
See **[Additional Member Portal Enhancements](#additional-member-portal-enhancements)** for other features post-V1.
...
<h2 id="additional-member-portal-enhancements" style={{ scrollMarginTop: "7rem" }}>Additional Member Portal Enhancements</h2>

- **[IPN Analytics & Data Infrastructure](/projects/ipn-operations-analytics):** How I brought membership, portal, event, email, social media, and website data into one place with automated daily updates.
- **[IPN Member Onboarding Redesign and Analytics](/projects/ipn-member-onboarding-redesign):** How I made onboarding clearer, reduced friction across devices, and added analytics to track member progress.
- **[IPN Member Notifications & Leadership Previews](/projects/ipn-member-notifications):** How I added automated member notifications and previews that leadership can review before publishing.
